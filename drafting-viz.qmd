...
sunflower_oil |> 
  ...
  theme(panel.grid = element_blank(),
        ...
        plot.background = element_rect(fill = "#fcfced"),
...
ggplot(data = sunflower_region) +
  geom_sf(aes(fill = Size), color = "white") +
  labs(title = "Size of Sunflower Farms",
       fill = "Hectares") +
  theme_void() +
  scale_fill_continuous(
    high = "#E7B030", low = platinum, na.value = "#cbe1f5",
  ...
  geom_sf(data = filter(sunflower_region, is.na(Size)),
          fill = "#cbe1f5", color = "white") +
  scale_fill_manual(name = NULL, values = "#cbe1f5",
                    labels = "No data",
